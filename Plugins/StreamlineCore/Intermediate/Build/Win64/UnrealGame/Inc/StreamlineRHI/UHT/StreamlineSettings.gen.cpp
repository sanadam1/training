...
struct Z_Construct_UClass_UStreamlineOverrideSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_LoadDebugOverlayOverride_MetaData[] = {
		{ "Category", "General Settings (Local)" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AllowOTAUpdateOverride_MetaData[] = {
		{ "Category", "General Settings (Local)" },
#if !UE_BUILD_SHIPPING
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_UseSlSetTagOverride_MetaData[] = {
		{ "Category", "Compatibility (Local)" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Use deprecated slSetTag instead of slSetTagForFrame.  Saved to local user config only **/" },
#endif
		{ "ConfigRestartRequired", "TRUE" },
		{ "DisplayName", "Use slSetTag (deprecated)" },
		{ "ModuleRelativePath", "Public/StreamlineSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Use deprecated slSetTag instead of slSetTagForFrame.  Saved to local user config only *" },
#endif
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FBytePropertyParams NewProp_AllowOTAUpdateOverride_Underlying;
	static const UECodeGen_Private::FEnumPropertyParams NewProp_AllowOTAUpdateOverride;
	...
	static const UECodeGen_Private::FBytePropertyParams NewProp_UseSlSetTagOverride_Underlying;
	static const UECodeGen_Private::FEnumPropertyParams NewProp_UseSlSetTagOverride;
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UStreamlineOverrideSettings_Statics::NewProp_AllowOTAUpdateOverride_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UStreamlineOverrideSettings_Statics::NewProp_AllowOTAUpdateOverride = { "AllowOTAUpdateOverride", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UStreamlineOverrideSettings, AllowOTAUpdateOverride), Z_Construct_UEnum_StreamlineRHI_EStreamlineSettingOverride, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AllowOTAUpdateOverride_MetaData), NewProp_AllowOTAUpdateOverride_MetaData) }; // 2869691042
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UStreamlineOverrideSettings_Statics::NewProp_UseSlSetTagOverride_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UStreamlineOverrideSettings_Statics::NewProp_UseSlSetTagOverride = { "UseSlSetTagOverride", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UStreamlineOverrideSettings, UseSlSetTagOverride), Z_Construct_UEnum_StreamlineRHI_EStreamlineSettingOverride, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_UseSlSetTagOverride_MetaData), NewProp_UseSlSetTagOverride_MetaData) }; // 2869691042
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UStreamlineOverrideSettings_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UStreamlineOverrideSettings_Statics::NewProp_AllowOTAUpdateOverride_Underlying,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UStreamlineOverrideSettings_Statics::NewProp_AllowOTAUpdateOverride,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UStreamlineOverrideSettings_Statics::NewProp_UseSlSetTagOverride_Underlying,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UStreamlineOverrideSettings_Statics::NewProp_UseSlSetTagOverride,
};
...
struct Z_Construct_UClass_UStreamlineSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bUseSlSetTag_MetaData[] = {
		{ "Category", "Compatibility" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Use deprecated slSetTag instead of slSetTagForFrame.*/" },
#endif
		{ "ConfigRestartRequired", "TRUE" },
		{ "DisplayName", "Use slSetTag (deprecated)" },
		{ "ModuleRelativePath", "Public/StreamlineSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Use deprecated slSetTag instead of slSetTagForFrame." },
#endif
	};
#endif // WITH_METADATA
	...
	static void NewProp_bUseSlSetTag_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bUseSlSetTag;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static UObject* (*const DependentSingletons[])();
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
void Z_Construct_UClass_UStreamlineSettings_Statics::NewProp_bUseSlSetTag_SetBit(void* Obj)
{
	((UStreamlineSettings*)Obj)->bUseSlSetTag = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UStreamlineSettings_Statics::NewProp_bUseSlSetTag = { "bUseSlSetTag", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UStreamlineSettings), &Z_Construct_UClass_UStreamlineSettings_Statics::NewProp_bUseSlSetTag_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bUseSlSetTag_MetaData), NewProp_bUseSlSetTag_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UStreamlineSettings_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UStreamlineSettings_Statics::NewProp_bUseSlSetTag,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_MyProject_Plugins_StreamlineCore_Source_StreamlineRHI_Public_StreamlineSettings_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UStreamlineOverrideSettings, UStreamlineOverrideSettings::StaticClass, TEXT("UStreamlineOverrideSettings"), &Z_Registration_Info_UClass_UStreamlineOverrideSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStreamlineOverrideSettings), 4062414025U) },
		{ Z_Construct_UClass_UStreamlineSettings, UStreamlineSettings::StaticClass, TEXT("UStreamlineSettings"), &Z_Registration_Info_UClass_UStreamlineSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStreamlineSettings), 2906308240U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject_Plugins_StreamlineCore_Source_StreamlineRHI_Public_StreamlineSettings_h_1601685241(TEXT("/Script/StreamlineRHI"),
	Z_CompiledInDeferFile_FID_MyProject_Plugins_StreamlineCore_Source_StreamlineRHI_Public_StreamlineSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject_Plugins_StreamlineCore_Source_StreamlineRHI_Public_StreamlineSettings_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_MyProject_Plugins_StreamlineCore_Source_StreamlineRHI_Public_StreamlineSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject_Plugins_StreamlineCore_Source_StreamlineRHI_Public_StreamlineSettings_h_Statics::EnumInfo));
// End Registration
